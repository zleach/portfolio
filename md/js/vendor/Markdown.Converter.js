...
(function () {
    ...
    Markdown.Converter = function (OPTIONS) {
        ...
        function writeImageTag(wholeMatch, m1, m2, m3, m4, m5, m6, m7) {
            ...
            var result = "<figure alt=\"" + alt_text + "\"><img src=\"" + url + "\" ";
            ...
            result += " /><figcaption>"+title+"</figcaption></figure>"
        ...
        function _DoHeaders(text) {
            ...
            text = text.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm,
                ...
                function (wholeMatch, m1) {
                    ...
                    return "<h1 data-uuid='"+UUID+"' >" + _RunSpanGamut(m1) + "</h1>\n\n"; 
                }
            );
            ...
            text = text.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm,
                function (matchFound, m1) {
                    var UUID = Math.random().toString(36).slice(2);
                    return "<h2 data-uuid='"+UUID+"' >" + _RunSpanGamut(m1) + "</h2>\n\n"; 
                }
            );
            ...
            */
            ...
            text = text.replace(/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm,
                function (wholeMatch, m1, m2) {
                    ...
                    return "<h" + h_level + " data-uuid='"+Math.random().toString(36).slice(2)+"' >" + _RunSpanGamut(m2) + "</h" + h_level + ">\n\n";
                }
            );
        ...
        function _FormParagraphs(text, doNotUnhash) {
            ...
            for (var i = 0; i < end; i++) {
                ...
                if (markerRe.test(str)) {
                    ...
                    var UUID = Math.random().toString(36).slice(2);
                    ContentMap.push([g_rawText.indexOf(grafs[i]),UUID])
                    str = _RunSpanGamut(str);
                    str = str.replace(/^([ \t]*)/g, "<p data-uuid='"+UUID+"' >");
                    str += "</p>"
                    grafsOut.push(str);
                }
